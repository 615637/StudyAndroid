...
import com.example.project01_lyjtalk.databinding.FragmentOpenTalkMainBinding;
...
public class OpenTalkMainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //jsp <-> Controller : jsp는 이미 조회가 완료 된 내용을 Model을 통해 받아서 el문법으로 보여주는 처리만 함. (Controller 비즈니스 로직)
